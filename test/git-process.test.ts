...
describe("Git read capability", () => {
  ...
  test("uses old Git for full repositories without passing an unknown option", async () => {
  ...
  test("keeps non-fetching reads on modern Git and rejects old partial clones", async () => {
